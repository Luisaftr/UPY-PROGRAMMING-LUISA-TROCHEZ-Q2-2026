...
while logged_in == False:
    ...
    if username in users and users[username]['password'] == password:
        ...
        print("\nWelcome, " + name + " (" + role + ")") #Salto de linea para organizar mejor/ optimizar y no poner tantos prints
        print("₊˚ ✧ ‿︵‿୨୧‿︵‿ ✧ ₊˚") 					#Decoración para separar
...
if role == 'student':
    print("⋆⁺₊⋆ ━━━━⊱༒︎ • ༒︎⊰━━━━ ⋆⁺₊⋆ REPORT CARD: " + name + " ⋆⁺₊⋆ ━━━━⊱༒︎ • ༒︎⊰━━━━ ⋆⁺₊⋆")
    aprobadas = set()
    pendientes = set()
    ...
    print("Pending subjects: ", pendientes)
...
# ______________________________________________________________________________________________________________
    ...
    if student_to_edit in notes:
        ...
        if subject_to_edit in notes[student_to_edit]:
            ...
            notes[student_to_edit][subject_to_edit] = new_grade
