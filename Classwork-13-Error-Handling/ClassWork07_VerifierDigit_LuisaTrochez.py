...
#Classwork 07 - Git/Github Repo - ERROR HANDELING
...
if len(partes) != 2:
    print("Error: No tiene el formato XXXXXXXXX-X")
    ...
    if rol.isdigit() == False:
        print("Error: Los digitos del rol deben ser numéricos")

    elif digito_ingresado.isdigit() == False:
        print("Error: El digito verificador debe ser numérico")
